...
public class CapsuleAgent : Agent
{
    ...
    void Start () {
        ...
        CapsuleInitialPosition = this.transform.position;
        CapsulePrePos = CapsuleInitialPosition;
        CapsuleInitialRotation = this.transform.rotation;
        
        // prevFrame = CaptureImage();
        // ssim = new SSIM();
        fileName = "rewardsCapsuleAgent.csv";
    ...
    public override void OnEpisodeBegin()
    {
        ...
        this.transform.rotation = CapsuleInitialRotation;
        this.transform.position = CapsuleInitialPosition;
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        sensor.AddObservation(Vector3.Distance(this.transform.position, Target));
    ...
    public override void OnActionReceived(float[] vectorAction)
    {
        ...
        if (Vector3.Distance(this.transform.position, Target1)<0.75f)
        ...
        float distanceToPrePos = Vector3.Distance(this.transform.position, CapsulePrePos);
        CapsulePrePos = this.transform.position;
        currVelo = rBody.velocity.magnitude;
        ...
        reward += (DynamicReward + alfa*distanceToPrePos - beta*(currVelo - safeVelo) );
