...
For pose estimation, ATE and RPE calculations can be done by using this [script](https://github.com/CapsuleEndoscope/VirtualCapsuleEndoscopy/Tasks/Pose and Depth Estimation/poseError.py)
